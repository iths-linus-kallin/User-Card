...
let i = 5;
let person = parsedData.results[[i]];

document.querySelector("h1").innerHTML = person.name.title + " " + person.name.first + " " + person.name.last;
...
var buttonleft = document.querySelector(".btn-right");
buttonleft.addEventListener('click', clickRight)
...
// let listMail = parsedData.results.map(findMail)
// console.log(listMail);

// parsedData.results.filter(function(person){
//     return person.nat == "FR";
// })

// console.log(parsedData.results.filter(function(person){
//     return person.nat == "FR";
// }));


// let person = parsedData.results[[]];
// let findFR = [];
// let findTitle = [];

// for(let person of parsedData.results){
//     if(person.nat == "FR"){
//     findFR.push(person);
//     }
// }
...
// for(let person of parsedData.results){
//     if(person.name.title == "Ms" || person.name.title == "Miss" || person.name.title == "Mademoiselle" || person.name.title == "Madame" || person.name.title == "Mrs"){
//     findTitle.push(person);
//     }
// }
